...
// Component for displaying direct contact details and social media links
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div className="space-y-4 text-gray-600">
          <p className="flex items-center">
            ...
            <a href={`mailto:${siteMetadata.email}`} className="hover:text-cyan-500">{siteMetadata.email}</a>
          </p>
          <p className="flex items-center">
            <svg className="w-5 h-5 mr-3 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
